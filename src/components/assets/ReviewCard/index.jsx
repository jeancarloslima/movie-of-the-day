...
export default function ReviewCard({
  ...
  return (
    <article
      className={`w-full max-w-[770px] cursor-pointer border-b border-gray-300 mb-6 md:px-0 ${index !== undefined ? "sm:border-b-0 sm:mb-0 sm:px-0" : ""} ${index === 0 ? "px-0 sm:px-4 sm:pr-4 md:pr-4 sm:row-span-2 sm:border-r border-gray-300 h-full lg:col-start-2 lg:pl-4 lg:border-l" : "sm:h-full px-4"} ${index === 2 ? "lg:col-start-1" : ""}`}
    >
