  ...
  return (
    <div className="flex m-auto max-w-3xl flex-col align-center justify-center gap-4 text-justify p-8">
      ...
      <p className="text-lg text-lg/8">
        ...
        become a developer for foreign countries until the end of the year.
      </p>
      ...
      <p className="text-lg text-lg/8">
        So, if everything goes well, you'll see a new movie review here every
        weekday. I'm not a specialist, just a cinephile completely passionated
        by cinema, so don't expect big things (also I'm a little dumb and as you
        can see my English is not that good). But this is very fun and effective
        for my learning, what is enough. Hope you enjoy and thank you for
        your time! :)
      </p>
    </div>
  );
