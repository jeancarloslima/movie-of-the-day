...
- Atualização diária e catálogo de filmes.
- Navegação fluida entre diferentes páginas e categorias de filmes.
...
`git clone https://github.com/jeancarloslima/movie-of-the-day.git`
